...
<body>
    <div class="container">
        <header>
            ...
            <div class="header-info">Quản lý kho hàng hiệu quả và chuyên nghiệp</div>
        </header>
        ...
        <div class="stats">
            ...
            <div class="stat-box">
                <div class="stat-number"><?php echo number_format($stats['total_value'], 0); ?> VNĐ</div>
                <div class="stat-label">Tổng Giá Trị</div>
            </div>
            <div class="stat-box">
                <div class="stat-number <?php echo $low_stock['low_stock'] > 0 ? 'quantity-low' : 'quantity-ok'; ?>">
                    <?php echo $low_stock['low_stock']; ?>
                </div>
